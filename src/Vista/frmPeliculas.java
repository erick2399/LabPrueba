...
public class frmPeliculas extends javax.swing.JDialog {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        // TODO add your handling code here:
        int security = tblPeliculas.getSelectedRow();
        if (security >= 0) {
            int accion =JOptionPane.showConfirmDialog(null, "Esta seguro de eliminar la casilla");
            if (accion == JOptionPane.YES_NO_OPTION) {
                almacenaPeli.eliminarPelicula(posi, peliObj);
                JOptionPane.showMessageDialog(this, "Registro eliminado");
                modelo.removeRow(tblPeliculas.getSelectedRow());
                lblRegistros.setText("Cantidad de registro" + String.valueOf(modelo.getRowCount()));
